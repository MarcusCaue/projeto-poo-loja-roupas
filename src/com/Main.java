...
public class Main {
  ...
  public static char tentarNovamente(Scanner sc) {
    System.out.print("Quer tentar novamente? ['S'/'N'] ");
    char escolha = sc.nextLine().toUpperCase().charAt(0);
    return escolha;
  }

  public static void menuCadastroUser(Loja loja, Scanner sc) {
  ...
  public static char menuFuncionario(Loja loja, Scanner sc) {
  ...
  public static char menuUsuario(Loja loja, Usuario user, Scanner sc) {
    ...
    // Devolver uma roupa
      ...
      if (loja.getAlugueis().size() == 0) {
        ...
        while (loja.verificarAluguel(idAluguel) == false) {
          ...
          decisao = tentarNovamente(sc);

          if (decisao == 'N') {
            break;
          } else {
            System.out.print("Informe o ID de um dos seus aluguéis: ");
            idAluguel = sc.nextInt();
          }
        }
  ...
  public static void main(String[] args) {
     ...
     * que elas só servem para armazenar dados que serão enviadas ao construtor da
     * Loja.
...

    {
      ...
      FuncionarioLoja f2 = new FuncionarioLoja("Paula Miranda Barbosa", funcionarios.size(),
          "paula@gerencia.com.br", "1234", "Desenvolvedora");
      funcionarios.add(f2);

      FuncionarioLoja f3 = new FuncionarioLoja("Priscila Mayumi", funcionarios.size(), "pri@gerencia.com.br",
          "1234", "Secretária");
      funcionarios.add(f3);
      ...
      // Login
        ...
        while (option == 'S') {
          ...
          if (loja.checaEmail(emailLogin) == false) {
            ...
            option = tentarNovamente(entrada);
          ...
          // Verifica se existe um funcionário cadastrado com esse email
            ...
            // Verifica se a senha informada condiz com a senha cadastrada
              ...
              if (senhaLogin.equals(senhaFuncionario) == false) {
                ...
                char decisao = 'S';
                while (decisao == 'S') {
                  decisao = menuFuncionario(loja, entrada);
                }
                option = 'N';
              }
            }
          ...
          // Verifica se existe um usuário cadastrado com esse email
            ...
            // Verifica se a senha informada condiz com a senha cadastrada
              ...
              if (senhaUsuario.equals(senhaLogin) == false) {
                ...
                char decisao = 'S';
                while (decisao == 'S') {
                  decisao = menuUsuario(loja, usuarioLogado, entrada);
                }
                option = 'N';
              }
            }
